...
const FoodGuessMode: React.FC<FoodGuessModeProps> = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    const mockFoodData = [
      { image: "/api/placeholder/400/300", country: "Italy", name: "Pizza Margherita", type: "food" },
      { image: "/api/placeholder/400/300", country: "Japan", name: "Sushi", type: "food" },
      { image: "/api/placeholder/400/300", country: "France", name: "Croissant", type: "food" },
      { image: "/api/placeholder/400/300", country: "Mexico", name: "Tacos", type: "food" },
      { image: "/api/placeholder/400/300", country: "Spain", name: "Paella", type: "food" },
    ];
    setPhotoData(mockFoodData);
  }, []);
    ...
    <div className={`photo-guess-mode ${flashCelebration ? "flash-bg" : ""}`}>
      {!started ? (
        ...
        <>
          ...
          <ResultModalFood result={result} show={showResult} score={scoreAnim ?? score} />
          {showResult && (
